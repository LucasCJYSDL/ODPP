...
def get_common_args():
    ...
    parser.add_argument('--env_id', type=str, default='AntControl-v0', help='RL environment') ###
...
def get_rl_args(args):
    ...
    args.batch_c = 40  # for the same s_0 how many c to collect
    args.batch_traj = 5  # for the same (s_0, c) how many trajectories to collect

    # network structure ### fine-tune based on the task
    args.nn_feature_dim = 50
    args.code_dim = 60 # number of skills to learn
    args.prior_hidden_dim = 128
    args.pi_hidden_dim = 128
    args.rnn_dec_hidden_dim = 128
    ...
    args.alpha_2 = 0.0  # 0.01 TODO: fine-tuning ### 0
    args.alpha_3 = 0.001 # 0.01 TODO: fine-tuning ### 0.001
