...
def get_common_args():
    ...
    parser.add_argument('--env_id', type=str, default='PointCorridor-v0', help='RL environment') # 'Point4Rooms-v0'
    ...
    parser.add_argument('--load_dir', type=str, default='./pre_ckpt_corr/ODPP_MAP_f_g_h/8000', help='where to load the pre_trained ckpt files')
...
def get_rl_args(args):
    ...
    args.alpha_2 = 0.01  # 0.01 TODO: fine-tuning
    args.alpha_3 = 0.01 # 0.01 TODO: fine-tuning
...
def get_laprepr_args(args):
    ...
    args.lap_train_steps = 30 # 30000, TODO: fine-tuning
...
def get_hierarchical_args(args):
    ...
    args.hier_episode_limit = 1000 # TODO: fine-tuning
