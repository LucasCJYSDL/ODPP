...
class ODPP_Agent(Option_Agent):
    ...
    def _get_landmarks(self, horizons, init_s, next_states, lap_repr: LapReprLearner):
    ...
    def train(self, episode_id, train_batch, lap_repr: LapReprLearner):
        ...
        landmarks, L_list, traj_fea_list, posterior_probs, map_lengths = self._get_landmarks(horizons, init_s, next_states, lap_repr)  # (bs, landmark_num, obs_dim)
        log_info = {}
