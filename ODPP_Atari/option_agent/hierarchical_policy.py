...
class HierPolicy(object):
    def __init__(self, args):
        ...
        self.prior_func = prior.Prior(input_dim=self.args.obs_dim, hidden_dim=self.args.prior_hidden_dim, code_dim=self.args.code_dim+1, is_high=True)
    ...
    def prim_train(self, episode_id, train_batch):
    ...
    def high_train(self, episode_id, train_batch):
        horizons = train_batch.get_item("horizon")  # (bs, 1)
        ...
        log_info['high_return'] = ret.mean().item()
